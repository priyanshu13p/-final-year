        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <div class="d-flex align-items-center justify-content-center">
              <img src="<?php echo e(url('/backend/img/logo.png')); ?>" alt="Logo" style="height: 30px; width: auto; display: block; border: 1px solid #ddd;" class="mr-2">
              <span>&copy; <?php echo e(date('Y')); ?> Developed By Sandesh-Priyanshu-Dipendra.</span>
            </div>
          </div>
        </div>
      </footer>
...
<?php /**PATH C:\xampp\htdocs\Ecommerce-Laravel\resources\views/user/layouts/footer.blade.php ENDPATH**/ ?>