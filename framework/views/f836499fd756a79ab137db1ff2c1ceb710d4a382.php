<header class="header shop">
                                    ...
                                    <ul class="shopping-list">
                                            ...
                                            <?php $__currentLoopData = Helper::getAllProductFromWishlist(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="cart-img" href="#"><img src="<?php echo e(asset('storage/'.$photo[0])); ?>" alt="<?php echo e($photo[0]); ?>"></a>
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li><a href="https://shopnearme.vercel.app/" target="_blank">ShopNearMe</a></li>
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH C:\xampp\htdocs\Ecommerce-Laravel\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>