    ...
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item <?php echo e((($key==0)? 'active' : '')); ?>">
                    <img class="first-slide" src="<?php echo e(asset(ltrim($banner->photo, '/'))); ?>" alt="First slide">
                    ...
                    <?php if($cat->is_parent==1): ?>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-banner">
                                <?php if($cat->photo): ?>
                                    <img src="<?php echo e(asset(ltrim($cat->photo, '/'))); ?>" alt="<?php echo e($cat->photo); ?>">
                                <?php else: ?>
            ...
            <div class="single-product">
                <div class="product-img">
                    <a href="<?php echo e(route('product-detail', $product->slug)); ?>">
                        ...
                        ?>
                        <img class="default-img" src="<?php echo e(asset(ltrim($photos[0], '/'))); ?>" alt="<?php echo e($photos[0]); ?>">
                        <img class="hover-img" src="<?php echo e(asset(ltrim($photos[0], '/'))); ?>" alt="<?php echo e($photos[0]); ?>">
                ...
                <?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            ?>
                            <img src="<?php echo e(asset(ltrim($photo[0], '/'))); ?>" alt="<?php echo e($photo[0]); ?>">
                            <div class="content">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <a href="<?php echo e(route('product-detail',$product->slug)); ?>">
                                    ...
                                    // dd($photo);
                                    ?>
                                    <img class="default-img" src="<?php echo e(asset(ltrim($photo[0], '/'))); ?>" alt="<?php echo e($photo[0]); ?>">
                                    <img class="hover-img" src="<?php echo e(asset(ltrim($photo[0], '/'))); ?>" alt="<?php echo e($photo[0]); ?>">
                ...
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            <img src="<?php echo e(asset(ltrim($post->photo, '/'))); ?>" alt="<?php echo e($post->photo); ?>">
                            <div class="content">
                                            ...
                                            <div class="quickview-slider-active">
                                                ...
                                                <?php $__currentLoopData = $photo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="single-slider">
                                                        <img src="<?php echo e(asset(ltrim($data, '/'))); ?>" alt="<?php echo e($data); ?>">
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Ecommerce-Laravel\resources\views/frontend/index.blade.php ENDPATH**/ ?>