				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>© <?php echo e(date('Y')); ?> Developed By Sandesh-Priyanshu-Dipendra  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	<script>
	  ...
	  </script><?php /**PATH C:\xampp\htdocs\Ecommerce-Laravel\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>